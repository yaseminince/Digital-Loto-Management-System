...
namespace LOTO.Web.Pages.Loto
{
    ...
    public class DeleteModel : PageModel
    {
        ...
        public DeleteModel(ILotoService lotoService,IUserService userService)
        {
        ...
        public async Task<IActionResult> OnGetDataAsync(int draw,int start,int length,
            [FromQuery] List<LotoStatus> statuses,[FromQuery] List<int> userIds,[FromQuery] List<LotoType> lotoTypes,
            DateTime? startDateFrom,DateTime? startDateTo,string searchValue,string sortColumn,string sortDirection)
        {
        ...
        public async Task<IActionResult> OnPostAsync(int lotoId)
        {
            ...
            {
                Entity = new LOTO.Domain.Entities.Loto
                {
                    Id = lotoId
                }
            };

            await _lotoService.DeleteAsync(request);

            ShowSuccessMessage = true;
            SuccessMessage = "Loto deleted successfully.";
            OnGet();
            return Page();
        }
    }
